...
$_LANG['cfg_name']['is_multi_discount'] = '購物車裡是否多次減免';
...
$_LANG['cfg_range']['is_multi_discount']['0'] = '否';
$_LANG['cfg_range']['is_multi_discount']['1'] = '是';
...
$_LANG['gzip_confirm'] = "GZip 功能需要您的服務器支持 zlib 擴展庫。\\n如果您發現開啟Gzip後頁面出現亂碼，可能是您的服務器已經開啟了Gzip，您不需要在 PBCC Store 中再次開啟。";
