...
$_LANG['label_user_surplus'] = '小熊卡充值';
$_LANG['label_pcoin_deposit'] = 'P币充值';
...
$_LANG['pay_order_by_surplus'] = '追加使用小熊卡支付订单：%s';
$_LANG['pay_order_by_surplus_cny'] = '追加使用小熊卡（人民币）支付订单：%s';
