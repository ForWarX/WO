...
<!--document.write('<li><img src="themes/pbccstore/qq/images/msn.gif" width="18" height="17" border="0" alt="MSN" /> <a href="msnim:chat?contact=MSN帐号">MSN咨询</a></li>');-->
...
document.write("<div id='divMenu' onmouseover='OnlineOver();'><img src='themes/pbccstore/images/askus.gif' class='press' alt='在线咨询'></div>");
