...
function showtime()
{
  ...
  if (dateLeft > 0)
  {
    Temp = dateZero + dateLeft + ' ' + hourZero + hourLeft + ' ' + minuteZero + minuteLeft + ' ' + secondZero + secondLeft + ' ';
  }
  else
  {
    if (hourLeft > 0)
    {
      Temp = dateZero + dateZero + ' ' + hourZero + hourLeft + ' ' + minuteZero + minuteLeft + ' ' + secondZero + secondLeft + ' ';
    }
    else
    {
      if (minuteLeft > 0)
      {
        Temp = dateZero + dateZero + ' ' + hourZero + hourZero + ' ' + minuteZero + minuteLeft + ' ' + secondZero + secondLeft + ' ';
      }
      else
      {
        if (secondLeft > 0)
        {
          Temp = dateZero + dateZero + ' ' + hourZero + hourZero + ' ' + minuteZero +minuteZero + ' ' + secondZero + secondLeft + ' ';
        }
        else
        {
          Temp = '';
...
function onload_leftTime(now_time)
{
  ...
  if (_GMTEndTime > 0)
  {
    ...
    {
      var tmp_val = parseInt(_GMTEndTime) - parseInt(cur_date.getTime() / 1000);
    }
    else
    {
