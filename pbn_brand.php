...
if (empty($brand_id))
{
    ...
    if (!$smarty->is_cached('pbn_brand_list.dwt', $cache_id))
    {
        assign_template();
		$_LANG['all_brand'] = "所有PBN品牌";
        ...
        $smarty->assign('brand_list', get_pbn_brands('','',$event_cat_id));
    }
    $smarty->display('pbn_brand_list.dwt', $cache_id);
    exit();
}
...
function get_pbn_brands($cat = 0, $app = 'brand', $cat_id)
{
    global $page_libs;
    ...
    $sql = "SELECT b.brand_id, b.brand_name, b.brand_logo, b.brand_desc, COUNT(*) AS goods_num, IF(b.brand_logo > '', '1', '0') AS tag ".
            "FROM " . $GLOBALS['ecs']->table('brand') . "AS b, (SELECT cat_id, brand_id, is_on_sale, is_alone_sale, is_delete FROM ".
                $GLOBALS['ecs']->table('goods') . ") AS g ".
            "WHERE g.brand_id = b.brand_id $children AND is_show = 1 AND g.cat_id = ".$cat_id." " .
