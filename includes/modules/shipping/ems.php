        ...
        else
        {
            ...
            else
            {
                if (($lb_goods_weight) > 1)
                {
					...
					$int_test_2 = (int)$lb_goods_weight;
					$diff = $lb_goods_weight - $int_test_2;
					$diff_100 = $diff * 100;
					$int_diff_100 = (int)$diff_100;
					if ($int_diff_100 > 1)
					{
						$fee += ceil($lb_goods_weight) * $step_1;
					}
					else
					{
						$fee += $lb_goods_weight * $step_1;
					}
                }
            }
