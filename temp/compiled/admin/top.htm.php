...
#submenu-div a.fix-submenu{clear:both; margin-left:5px; padding:1px 5px; *padding:3px 5px 5px; border:2px solid #363636; color:#363636;}
#submenu-div a.fix-submenu:hover{padding:1px 5px; *padding:3px 5px 5px; background:#363636; color:#FFF;}
#menu-div li.fix-spacel{width:30px; border-left:none; background-color: #EF5A2C;}
...
<body>
<div id="header-div">
  <div id="logo-div" style="bgcolor:#000000;"><img src="images/logo.gif" alt="Power for Polar Bear Canada Corp." /></div>
